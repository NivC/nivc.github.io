...
{% if site.author.googlescholar %}
 ...
 <div class="wordwrap">This is a short list of selected publications. <br> You can find the full list of publications on <a href="{{site.author.googlescholar}}">my Google Scholar profile</a>.</div>
{% endif %}
